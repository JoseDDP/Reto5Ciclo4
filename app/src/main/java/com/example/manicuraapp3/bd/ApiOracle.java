package com.example.manicuraapp3.bd;
...
public class ApiOracle {
    ...
    private String urlSucursales = "https://g4c5a7eb22d6797-androidreto5.adb.us-ashburn-1.oraclecloudapps.com/ords/admin/sucursales/sucursales";
    private String urlProductos = "asdfas";
    ...
    public void insertSucursal(String name, String description, String location, ImageView imageView){
        ...
        String image = casoUsoSucursales.imageViewToString(imageView);
        try {
            json.put("name", name);
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i=0; i<jsonArray.length(); i++){
                        ...
                        byte[] image = casoUsoSucursales.stringToByte(jsonObject.getString("image"));
